"""
Django settings for komatsuprepreptest_46125 project.
...
ROOT_URLCONF = 'komatsuprepreptest_46125.urls'
...
WSGI_APPLICATION = 'komatsuprepreptest_46125.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "komatsuprepreptest_46125 API",
    "DESCRIPTION": "API documentation for komatsuprepreptest_46125 App",
    "VERSION": "v1",
}
